 ...
 * @property User[] $users
 */
class PersonName extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
   // public $age;
    ...
    {
        return [
            [['given_name', 'family_name','room','payment_category_concept_id','opd_service','visit_type','age','gender'], 'required'],
            [['insurance_concept_id','insurance_number'], 'required','when' => function ($model) { 
                    return $model->payment_category_concept_id == 4031; 
                }, 
                'whenClient' => "function (attribute, value) { 
                    return $('#personname-payment_category_concept_id').val() == '4031'; 
                }"
            ],
            ...
            'whenClient' => "function (attribute, value) { 
                return $('#personname-payment_category_concept_id').val() == '4030'; 
            }"
           ],
