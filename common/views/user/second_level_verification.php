...
<?php $form =ActiveForm::begin(['id'=>'code-verification-form']); ?>
    <div class="panel panel-body login-form">
        <div class="text-center">
            ...
            <h5 class="content-group">Second Level Verification<small class="display-block"><b>2/2</b> User Confirmation</small></h5>
        </div>
...
<script>
    $(document).ready(function () {
       ...
       // $('#pnotify-permanent-buttons').on('click', function () {
            new PNotify({
                title: "<spa class='icon-mobile'></span> Verification code!",
                text: "<h3 class=''> <?= Yii::$app->session['verification_code']; ?></h3>",
                addclass: 'bg-slate',
                buttons: {
                    closer_hover: false,
                    sticker_hover: false
