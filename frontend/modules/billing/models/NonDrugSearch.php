...
/**
 * frontend\modules\billing\models\NonDrugSearch represents the model behind the search form about `frontend\modules\clinical\models\NonDrug`.
 */
 class NonDrugSearch extends NonDrug
{
    /**
     * @inheritdoc
     */
