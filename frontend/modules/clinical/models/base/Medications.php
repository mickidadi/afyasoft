...
class Medications extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\frontend\modules\clinical\models\BlDiscount::className(), ['quote_line' => 'quote_line_id']);
    }
    ...
    {
        return $this->hasOne(\frontend\modules\clinical\models\BlSaleOrderByQuoteLine::className(), ['quote_line' => 'quote_line_id']);
    }
    ...
    {
        return $this->hasOne(\frontend\modules\clinical\models\User::className(), ['id' => 'created_by']);
    }
    ...
    {
        return $this->hasOne(\frontend\modules\clinical\models\BlItemPrice::className(), ['item_price_id' => 'item_price']);
    }
    ...
    {
        return $this->hasOne(\frontend\modules\clinical\models\Concept::className(), ['concept_id' => 'payment_category']);
    }
    ...
    {
        return $this->hasOne(\frontend\modules\clinical\models\Concept::className(), ['concept_id' => 'payment_sub_category']);
    }
    ...
    {
        return $this->hasOne(\frontend\modules\clinical\models\BlSaleQuote::className(), ['quote_id' => 'sale_quote']);
    }
    ...
    {
        return $this->hasOne(\frontend\modules\clinical\models\BlServiceType::className(), ['service_type_id' => 'service_type']);
    }
    ...
    {
        return $this->hasOne(\frontend\modules\clinical\models\BlQuoteStatusCode::className(), ['status_code_id' => 'status']);
    }
    ...
    {
        return $this->hasMany(\frontend\modules\clinical\models\BlSaleQuoteReferenceMap::className(), ['sale_quote_line' => 'quote_line_id']);
    }
    ...
    {
        return $this->hasOne(\frontend\modules\clinical\models\DrugQuoteLine::className(), ['quote_line_id' => 'quote_line_id']);
    }
