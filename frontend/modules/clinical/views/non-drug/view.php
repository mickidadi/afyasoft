...
/* @var $model frontend\modules\clinical\models\NonDrug */

$this->title = $model->quote_line_id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Non Drug'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="non-drug-view">

    <div class="row">
        <div class="col-sm-9">
            <h2><?= Yii::t('app', 'Non Drug').' '. Html::encode($this->title) ?></h2>
        </div>
...
?>
    ...
    <div class="row">
        <h4>DrugQuoteLine<?= ' '. Html::encode($this->title) ?></h4>
    </div>
    <?php 
    $gridColumnDrugQuoteLine = [
        'drug_inventory_id',
        'patient_id',
        'visit_id',
        'dose',
    ...
    echo DetailView::widget([
        'model' => $model->drugQuoteLine,
        'attributes' => $gridColumnDrugQuoteLine    ]);
    ?>
</div>
