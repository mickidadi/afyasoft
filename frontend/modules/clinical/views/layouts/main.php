...
<head>
    ...
    <title>AfyaCare ++</title>
    <link rel="icon" type="image/x-icon" href="themes/assets/img/favicon.ico" />
    <link href="themes/assets/css/loader.css" rel="stylesheet" type="text/css" />
    <script src="themes/assets/js/loader.js"></script>
    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Quicksand:400,500,600,700&display=swap" rel="stylesheet">
    <link href="themes/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="themes/assets/css/plugins.css" rel="stylesheet" type="text/css" />
    <link href="themes/assets/css/structure.css" rel="stylesheet" type="text/css" class="structure" />
    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM STYLES -->
    <link href="themes/plugins/apex/apexcharts.css" rel="stylesheet" type="text/css">
    <link href="themes/assets/css/dashboard/dash_1.css" rel="stylesheet" type="text/css" class="dashboard-analytics" />
    <link href="themes/plugins/jquery-ui/jquery-ui.min.css" rel="stylesheet" type="text/css" />
    <!-- END PAGE LEVEL PLUGINS/CUSTOM STYLES -->
    <link href="themes/plugins/animate/animate.css" rel="stylesheet" type="text/css" />
    <script src="themes/plugins/sweetalerts/promise-polyfill.js"></script>
    <link href="themes/plugins/sweetalerts/sweetalert2.min.css" rel="stylesheet" type="text/css" />
    <link href="themes/plugins/sweetalerts/sweetalert.css" rel="stylesheet" type="text/css" />
    <link href="themes/assets/css/components/custom-sweetalert.css" rel="stylesheet" type="text/css" />
    <link href="themes/assets/css/apps/mailbox.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="themes/plugins/editors/quill/quill.snow.css">
    <link href="themes/3assets/css/users/user-profile.css" rel="stylesheet" type="text/css" />
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM STYLES -->
    <link href="themes/assets/css/pages/faq/faq2.css" rel="stylesheet" type="text/css" />
    <!-- END PAGE LEVEL PLUGINS/CUSTOM STYLES -->
</head>
<body class="alt-menu sidebar-noneoverflow">
    ...
    <!-- END MAIN CONTAINER -->
        ...
        <script src="themes/assets/js/libs/jquery-3.1.1.min.js"></script>
        <script src="themes/bootstrap/js/popper.min.js"></script>
        <script src="themes/bootstrap/js/bootstrap.min.js"></script>
        <script src="themes/plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>
        <script src="themes/assets/js/app.js"></script>
        <script src="themes/assets/js/pages/faq/faq2.js"></script>
        <script>
            ...
            function changeLocation() {
                var location_id = $("#service-location_id").val();
                // alert(location_id);   
                $.ajax({
                    type: 'post',
                    url: "<?php echo \Yii::$app->getUrlManager()->createUrl('/registration/default/save-location'); ?>",
                    data: {
                    ...
                    success: function(data) {
                        swal({
                            title: 'Good Job!',
                            text: "Location Change Successfully!",
                            type: 'success',
                            padding: '2em'
                        })
                        // console.log(data); 
        ...
        <script src="themes/plugins/apex/apexcharts.min.js"></script>
        <script src="themes/assets/js/dashboard/dash_1.js"></script>
        <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
        <script src="themes/plugins/jquery-ui/jquery-ui.min.js"></script>
        <script src="themes/assets/js/apps/contact.js"></script>
        <!-- BEGIN THEME GLOBAL STYLE -->
        <script src="themes/assets/js/scrollspyNav.js"></script>
        <script src="themes/plugins/sweetalerts/sweetalert2.min.js"></script>
        <script src="themes/plugins/sweetalerts/custom-sweetalert.js"></script>
        <script src="themes/assets/js/apps/custom-mailbox.js"></script>
        <script src="themes/assets/js/ie11fix/fn.fix-padStart.js"></script>
        <script src="themes/plugins/editors/quill/quill.js"></script>
